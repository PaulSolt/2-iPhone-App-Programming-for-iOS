...
//    self.frameWidthSlider.denominator = 8;
    ...
    self.leftBorderFractionLabel.backgroundColor = [UIColor clearColor];
    self.rightBorderFractionLabel.backgroundColor = [UIColor clearColor];
    self.topBorderFractionLabel.backgroundColor = [UIColor clearColor];
    self.bottomBorderFractionLabel.backgroundColor = [UIColor clearColor];
    
    UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleImageTapGesture:)];
    [self.imageView addGestureRecognizer:tapGesture];
    self.imageView.userInteractionEnabled = YES;
}

- (void)handleImageTapGesture:(UITapGestureRecognizer *)gesture {
