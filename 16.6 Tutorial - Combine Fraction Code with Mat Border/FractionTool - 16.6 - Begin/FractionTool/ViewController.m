...
- (void)viewDidLoad
{
    ...
    for(int i = 0; i <= 8; i++) {
        ...
        Fraction *fraction = [[Fraction alloc] initWithNumerator:number denominator:0];
    ...
    double number = 0.625;
    Fraction *convertedFraction = [FractionHelper convertNumberToFraction:number];
    NSLog(@"convertedFraction: %f to %@", number, convertedFraction);
